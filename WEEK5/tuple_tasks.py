...
# Function to create a tuple with likelihoods and return the smallest value
def likelihood():
    # Tuples are like lists but can't be changed - perfect for this data
    likelihoods = (50, 38, 27, 99, 4)  # Likelihoods of tiles falling
    min_value = min(likelihoods)  # Find the smallest value in the tuple
    return min_value  # Return the minimum likelihood

# Function to run task 1 and display the minimum likelihood
def run_task1():
    smallest = likelihood()  # Call the function to get the minimum value
    print(f"Minimum likelihood of falling: {smallest}%")  # Display the result

# Make sure the program only runs this if executed directly
